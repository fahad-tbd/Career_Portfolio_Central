...
export default function ContactPage() {
  ...
  const contactMethods = [
    ...
    },
    {
      ...
      title: 'Call Us',
      primary: '1-800-CAREER-1',
      secondary: 'Mon-Fri 9AM-6PM EST',
      bgColor: 'from-green-500 to-green-600',
      color: 'text-green-600',
      action: 'tel:+18002273371'
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      secondary: 'Customer Experience Center',
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {contactMethods.map((method, index) => (
                ...
                >
                  ...
                  {/* Icon */}
                  <div className={`inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br ${method.bgColor} text-white rounded-xl mb-6 transform group-hover:scale-110 transition-transform duration-300 shadow-lg`}>
                    {method.icon}
                  </div>
                  ...
                  <div className="relative z-10">
                    ...
                    <p className={`font-semibold text-lg mb-2 ${method.color} group-hover:text-brand-navy transition-colors duration-300`}>
                      {method.primary}
                    </p>
